...
ACLOCAL = ${SHELL} U:/progetti/giflib-4.1.6/missing --run aclocal-1.10
AMTAR = tar.exe
AR = ar.exe
AUTOCONF = ${SHELL} U:/progetti/giflib-4.1.6/missing --run autoconf
AUTOHEADER = ${SHELL} U:/progetti/giflib-4.1.6/missing --run autoheader
AUTOMAKE = ${SHELL} U:/progetti/giflib-4.1.6/missing --run automake-1.10
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -D__EMX__ -DOS2  -D__ST_MT_ERRNO__ -g -Wall
COMPILABLE_EXTRAS =  gifclrmp.exe gifrotat.exe
CPP = gcc -E
CPPFLAGS = 
CXX = g++
CXXCPP = g++ -E
...
X_LIBS = 
X_PRE_LIBS = 
abs_builddir = U:/progetti/giflib-4.1.6
abs_srcdir = U:/progetti/giflib-4.1.6
abs_top_builddir = U:/progetti/giflib-4.1.6
abs_top_srcdir = U:/progetti/giflib-4.1.6
ac_ct_CC = gcc
ac_ct_CXX = 
ac_ct_F77 = gfortran
am__include = include
...
install_sh = $(SHELL) U:/progetti/giflib-4.1.6/install-sh
